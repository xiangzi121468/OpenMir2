...
uses
  ...
  MSI_Printers, MSI_Processes, MSI_ProcListMon, MSI_ProcMon, MSI_Security, 
  MSI_SMBIOS, MSI_Software, MSI_Startup, MSI_Storage, MSI_SvcListMon, 
  MSI_SysModListMon, MSI_SysMon, MSI_SystemInfo, MSI_USB, MSI_WIFI, 
